...
void* checkPower(void* param)
{
    ...
    while(true)
    {
        ...
        if(line == "NONE")
        {
            g_pDialog->ui->pbok->setStyleSheet("background: rgba(56,159,241,0.3);border-radius: 5px;color:#FFFFFF");
